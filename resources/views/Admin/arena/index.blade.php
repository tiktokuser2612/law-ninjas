                              ...
                              <tr>
                                ...
                                <td class="min-width">
                                    <div class="employee-image">
                                        <img src="{{url('/storage/app/public/Admin/Arena/'.$row->image)}}" alt="" />
                                    </div>
                                </td>
                                <td class="min-width">
                                    <p>{{$row->name}}</p>
                                ...
                                @if(empty($row->password))
                                     <p class="status-btn close-btn">
                                        <i class="mdi mdi-lock-open"></i>
                                    </p>
                                    @else
                                     <p class="status-btn success-btn">
                                  ...
                                  @endif
                                   ...
                                   <td>
                                    @php $prodID= Crypt::encrypt($row->id); @endphp
                                     <a href="{{url('/admin/arena/show/'.$prodID)}}" class="status-btn success-btn"><i class="mdi mdi-eye-outline"></i></a>
                                    <td>
                                 <td class="min-width">
